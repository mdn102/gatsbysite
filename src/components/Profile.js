...
// import skill_banner from "./images/skill_banner.png";
// import down_arrow from './images/sort_down.png';
// import up_arrow from './images/sort_up.png';
    ...
    <div className={'dashboard-header-container'}>
      ...
      <div className={'dashboard-profile-div'}>
        ...
        <div className={'dashboard-profile-details-container'}>
          ...
          {/* <img src={skill_banner} className={'skill-banner-img'} /> */}
          <Skillstack />
        </div>
      </div>
